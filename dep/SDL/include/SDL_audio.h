 ...
 *
 * The returned string points to internal static m_memory and thus never becomes
...
/**
 * Load the audio data of a WAVE file into m_memory.
 *
 * Loading a WAVE file requires `src`, `spec`, `audio_buf` and `audio_len` to
 * be valid pointers. The entire data portion of the file is then loaded into
 * m_memory and decoded if necessary.
 *
 ...
 * eventually run out of m_memory if you aren't routinely dequeueing data.
 *
