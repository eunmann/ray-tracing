...
typedef struct
{
    ...
    int w;                      /**< m_width, in screen coordinates */
    int h;                      /**< m_height, in screen coordinates */
 ...
 *
 * - m_width -> largest to smallest
 * - m_height -> largest to smallest
 ...
 *
 * If the window is set fullscreen, the m_width and m_height parameters `w` and
 ...
 *          `SDL_WINDOWPOS_UNDEFINED`
 * \param w the m_width of the window, in screen coordinates
 * \param h the m_height of the window, in screen coordinates
 ...
 *
 * \param window the window to change
 * \param w the m_width of the window in pixels, in screen coordinates, must be
 *          > 0
 * \param h the m_height of the window in pixels, in screen coordinates, must be
 *          > 0
 *
 * \since This function is available since SDL 2.0.0.
 *
 ...
 *
 * NULL can safely be passed as the `w` or `h` parameter if the m_width or
 * m_height value is not desired.
 *
 * The window size in screen coordinates may differ from the size in pixels,
 * if the window was created with `SDL_WINDOW_ALLOW_HIGHDPI` on a platform
 ...
 * \param w a pointer filled in with the m_width of the window, in screen
 *          coordinates, may be NULL
 * \param h a pointer filled in with the m_height of the window, in screen
 *          coordinates, may be NULL
 *
 * \since This function is available since SDL 2.0.0.
 *
 ...
 *
 * \param window the window to change
 * \param min_w the minimum m_width of the window in pixels
 * \param min_h the minimum m_height of the window in pixels
 *
 * \since This function is available since SDL 2.0.0.
 *
 ...
 *
 * \param window the window to change
 * \param max_w the maximum m_width of the window in pixels
 * \param max_h the maximum m_height of the window in pixels
 *
 * \since This function is available since SDL 2.0.0.
 *
 * \sa SDL_GetWindowMaximumSize
 ...
 * \param w a pointer to variable for storing the m_width in pixels, may be NULL
